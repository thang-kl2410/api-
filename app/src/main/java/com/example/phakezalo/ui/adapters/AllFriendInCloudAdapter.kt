...
class AllFriendInCloudAdapter(private var listFriend:List<Friend>,
                               private var messageViewModel: MessageViewModel,
): RecyclerView.Adapter<AllFriendInCloudAdapter.Holder>() {
    ...
    inner class Holder(item: View): RecyclerView.ViewHolder(item), View.OnCreateContextMenuListener {
        ...
        override fun onCreateContextMenu(
            ...
            inflater.inflate(R.menu.context_item_cloud, menu)
